  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="bg-white text-gray-900 p-4 lg:p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div>
              ...
              <h1 className="text-2xl lg:text-3xl font-bold mb-2">Add New Product</h1>
        ...
        {/* Form Section */}
        <div className="bg-white text-gray-900 p-4 lg:p-6 rounded-xl shadow-sm border border-gray-200 max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-blue-800 text-sm font-medium">Quick Tips</p>
                  <p className="text-blue-600 text-xs mt-1">
                    Fill in all required fields (*) to create a new product. 
                    The product will be immediately available for orders after creation.
                  </p>
                </div>
              </div>
            </div>
